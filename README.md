...
![TRELLIS.2 HiCache runtime path](docs/flow.svg)

TRELLIS.2 shape stages keep separate schedule and cache identities. Unsupported texture paths remain outside the accelerated boundary and are reported explicitly.
